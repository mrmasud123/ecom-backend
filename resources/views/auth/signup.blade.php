    ...
    <div class="relative z-1 min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#FFF3E6] via-[#FFE8D6] to-[#FFDDD2] dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 px-4 py-10 font-sans">
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="text-center mb-2">
                <span class="text-[11px] font-semibold tracking-widest text-[#FF7A1A] uppercase drop-shadow-sm">Join Us · Create Account</span>
            </div>
            ...
            <div class="relative bg-white/30 dark:bg-white/5 backdrop-blur-2xl rounded-2xl shadow-2xl shadow-orange-900/10 border border-white/50 dark:border-white/10 p-7 sm:p-8 ring-1 ring-white/40 dark:ring-white/5">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex items-center justify-center mb-5">
                        ...
                        <span class="relative bg-white/0 backdrop-blur-sm px-3 text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400">or sign up with email</span>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="post" id="signupForm">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="phone_number" name="phone_number" placeholder="+880 1XXXXXXXXX"
                                       class="h-11 w-full rounded-lg border border-white/60 dark:border-white/10 bg-white/40 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-800 dark:text-white/90 placeholder:text-gray-500 focus:outline-none focus:ring-3 focus:ring-[#FF7A1A]/20 focus:border-[#FF7A1A] focus:bg-white/60" />
                            </div>
                            ...
                            <div x-data="{ checkboxToggle: false }">
                                <label for="terms" class="flex cursor-pointer items-start text-sm font-normal text-gray-700 dark:text-gray-300 select-none">
                                    ...
                                    <span>I agree to the <a href="/terms" class="text-[#FF7A1A] hover:text-[#E9660A] font-medium">Terms of Service</a> and <a href="/privacy" class="text-[#FF7A1A] hover:text-[#E9660A] font-medium">Privacy Policy</a></span>
                                </label>
                            </div>
                    ...
                    <p class="mt-6 text-center text-sm font-normal text-gray-600 dark:text-gray-400">
                        ...
                        <a href="/login" class="text-[#FF7A1A] hover:text-[#E9660A] font-medium">Sign In</a>
                    </p>
