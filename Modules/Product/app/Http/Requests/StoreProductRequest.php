...
class StoreProductRequest extends FormRequest
{
    ...
    {
        return [
            'compare_price.gt' => 'The compare-at price should be higher than the price, otherwise it won\'t look like a discount.',
            'quantity.required_if' => 'Enter how many are in stock, or turn off quantity tracking.',
        ];
    }
}
