<div class="flex items-center justify-end gap-2">
    ...
    <button type="button"
            class="delete-product inline-flex items-center justify-center h-8 w-8 rounded-md text-gray-500 hover:bg-gray-100 hover:text-red-600 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-red-400 transition-colors"
            data-id="{{ $product->id }}"
